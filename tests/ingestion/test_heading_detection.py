...
class TestIsLayoutHeading:
    ...
    def test_rejects_text_with_too_many_words(self):
        long_text = "This is a very long sentence that should not be considered a heading"
        assert _is_layout_heading(long_text, size=14.0, body_size=10.0, is_bold=True) is False
